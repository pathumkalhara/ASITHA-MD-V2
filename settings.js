...
module.exports = {
SESSION_ID: process.env.SESSION_ID === undefined ? '𝙰𝚂𝙸𝚃𝙷𝙰-𝙼𝙳=SvwAQBpQ#CEs6OgG7Mu1DPqjTvMWp7DF8SdtJsrpVhcnWSX44Sdc' : process.env.SESSION_ID,
PREFIX: process.env.PREFIX || '.' ,
ALIVE_MSG: process.env.ALIVE_MSG === undefined ? "*🐼හෙලෝ..කොහොමද ඔයාට..🍁!*" : process.env.ALIVE_MSG,
AUTO_READ_STATUS: process.env.AUTO_READ_STATUS === undefined ?"true" : process.env.AUTO_READ_STATUS,
STATUS_REPLY_MSG: process.env.STATUS_REPLY_MSG || "│𝘠𝘖𝘜𝘙 𝘚𝘛𝘈𝘛𝘜𝘚 𝘝𝘐𝘌𝘞𝘌𝘋 𝘉𝘠 𝘗𝘈𝘛𝘏𝘜𝘔...🎁!",
